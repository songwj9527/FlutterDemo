...
class DashedDecoration extends Decoration {
  ...
  @override
  EdgeInsetsGeometry get padding => (border != null) ?  (border!.dimensions): EdgeInsets.fromLTRB(0, 0, 0, 0);
  ...
  Path getClipPath(Rect rect, TextDirection textDirection) {
    ...
    return clipPath??Path()..addRect(rect);
  }
  ...
  static DashedDecoration? lerp(DashedDecoration? a, DashedDecoration? b, double t) {
    assert(t != null);
...
class _BoxDecorationPainter extends BoxPainter {
  ...
  void paint(Canvas canvas, Offset offset, ImageConfiguration? configuration) {
    ...
    Paint dashedPaint = Paint()
      ..color = _decoration!.dashedColor??Colors.transparent
